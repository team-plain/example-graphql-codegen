...
async function example() {
  const createThreadResponse = await request({
    apiKey: API_KEY,
    // 👇 This is autogenerated based on the mutation in the graphql folder
    // and allows this function to infer all types so that the inputs as well
    // as results are 100% typesafe.
